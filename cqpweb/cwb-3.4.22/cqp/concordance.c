                  ...
                  Mapping *mappings)
{
  ...
  /* dummies: because the arguments of some other functions require address of an int to be passed... */
  int token_p;
  ...
  get_print_attribute_values(cd, match_start, line, cd->print_cpos && (orientation == ConcLineHorizontal), pdr);
