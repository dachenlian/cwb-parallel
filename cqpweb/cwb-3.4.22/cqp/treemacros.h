...
/**
 * @file The preprocessor macros here are used largely in parser.y and parse_actions.c
 */
...
/** Macro to allocate a new Evaltree object */
...
///** Macro to call cl_free() on a Constrainttree note. */
