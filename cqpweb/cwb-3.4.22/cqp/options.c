...
parse_options(int ac, char *av[])
{
  ...
  while (EOF != (c = getopt(ac, av, valid_options)))
    ...
    case 'i':
      ...
      rangeoutput = True;
      silent = True;
      verbose_parser = show_symtab = show_gconstraints = show_evaltree = show_patlist = symtab_debug = parser_debug = eval_debug = search_debug = False;
    ...
    case 'f':
      batchmode = True;
      silent = True;
      verbose_parser = show_symtab = show_gconstraints = show_dfa = show_compdfa = show_evaltree = show_patlist = symtab_debug = parser_debug = eval_debug = search_debug = False;
