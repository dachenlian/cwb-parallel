...
/**
 * RangeSetOp enum: indicates a specific type of operation that can be
...
/* match operation modes (for deletions) ------------------------------------- */

#define ALL_LINES        1       /**< delete all matches/intervals */
#define SELECTED_LINES   2       /**< delete the selected matches/intervals */
#define UNSELECTED_LINES 3       /**< delete all but the selected matches/intervals */
