 ...
 * (It also seems not to be used anywhere.)
 *
...
cl_id2sort(Attribute *attribute, int id)
{
  ...
  /* TODO a proper implementation of the above so the "CDA_ENYI" can be removed */
  cl_errno = CDA_OK;
  return offset;
 ...
 * @param word_ids              A list of lexicon item ids (i.e. id codes for
