package CWB::CQI::Client;
# -*-cperl-*-
$VERSION = 3.000_000;  # version 3.0.0 in Perl format
...
CWB::CQI::Client - CQi client library (reference implementation)
...
B<** TODO **> (add inline POD documentation to each function definition)
