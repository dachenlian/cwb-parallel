package CWB;
# -*-cperl-*-
$VERSION = 3.000_006; # 3.0.6 in standard Perl format
...
# the valgrind command either runs executables within Valgrind, or else does nothing (empty string)
my $vg_cmd = $CWB::Config::ValgrindCmd;
# only used for creation of the global applicatuion paths below. 

# global variables: full paths to CWB tools
our $Config      = "$BinDir/cwb-config";              # This is a shell script; doesn't need the Valgrind prefix.
our $SEncode     = "$vg_cmd$BinDir/cwb-s-encode";
our $SDecode     = "$vg_cmd$BinDir/cwb-s-decode";
our $Encode      = "$vg_cmd$BinDir/cwb-encode";
our $Decode      = "$vg_cmd$BinDir/cwb-decode";
our $Lexdecode   = "$vg_cmd$BinDir/cwb-lexdecode";
our $Makeall     = "$vg_cmd$BinDir/cwb-makeall";
our $DescribeCorpus = "$vg_cmd$BinDir/cwb-describe-corpus";
our $Itoa        = "$vg_cmd$BinDir/cwb-itoa";
our $Atoi        = "$vg_cmd$BinDir/cwb-atoi";
our $CompressRdx = "$vg_cmd$BinDir/cwb-compress-rdx";
our $Huffcode    = "$vg_cmd$BinDir/cwb-huffcode";
our $ScanCorpus  = "$vg_cmd$BinDir/cwb-scan-corpus";
our $Align       = "$vg_cmd$BinDir/cwb-align";
our $AlignEncode = "$vg_cmd$BinDir/cwb-align-encode";
our $CQP         = "$vg_cmd$BinDir/cqp";
our $CQPserver   = "$vg_cmd$BinDir/cqpserver";
